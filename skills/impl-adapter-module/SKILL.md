...
- 与本 Skill 打包的 Case（包结构、config 默认内置 BaseController/GlobalExceptionHandler/TokenValidationFilter、CommandController、QueryController）：[reference.md](reference.md)。
